...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Optimized backend query patterns achieving ~30% database performance gains for high-frequency operational queries',
    ...
    technologies: ['React', 'Node.js', 'MongoDB', 'AWS', 'Operational dashboards', 'Shipping integrations', 'Query optimization'],
  },
  {
    id: 'embrace',
    title: 'Senior Front-End Engineer',
    ...
    bullets: [
      ...
      'Developed responsive, cross-client email templates integrated with SendGrid workflows',
      'Automated daily digest generation and delivery pipelines for usage insights',
    ],
    technologies: ['React', 'TypeScript', 'Component library design', 'SendGrid', 'Email templating', 'Automation workflows'],
  },
  {
    id: 'riviera-partners',
    title: 'Senior Front-End Engineer',
    ...
    bullets: [
      ...
      'Implemented performance-focused rendering and asset strategies reducing page load times by ~50% while preserving SEO and UX quality',
      'Established foundational testing practices and CI quality gates to reduce regressions and increase release confidence',
    ],
    technologies: ['React', 'JavaScript', 'TypeScript', 'Frontend migration strategy', 'Test automation', 'CI/CD foundations'],
  },
  {
    id: 'smartsheet',
    title: 'Senior Front-End Engineer',
